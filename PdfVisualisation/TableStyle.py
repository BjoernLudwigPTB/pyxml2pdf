...
class TableStyle:
    def __init__(self):
        self.heading = [Styles.align_left, Styles.valign_middle, Styles.background(colors.lightgrey),
                        Styles.box(colors.black), Styles.inner_grid(colors.black)]

        self.sub_heading = [Styles.align_left, Styles.valign_middle, Styles.box(colors.black),
                            Styles.inner_grid(colors.black)]

        self.normal = [Styles.align_left, Styles.valign_middle, Styles.box(colors.black),
                       Styles.inner_grid(colors.black)]
